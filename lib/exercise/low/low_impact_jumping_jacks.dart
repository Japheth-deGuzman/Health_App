...
class LowImpactJumpingJacks extends StatefulWidget {
  const LowImpactJumpingJacks({Key? key}) : super(key: key);

  @override
  _LowImpactJumpingJacksState createState() => _LowImpactJumpingJacksState();
}

class _LowImpactJumpingJacksState extends State<LowImpactJumpingJacks> {
  bool isCliked = true;
  ...
  String time = '';
  String secs = '';
  String exercise = 'Low Impact Jumping Jacks';
  String level = 'Low Level Exercise';
                  ...
                  Container(
                    ...
                    child: FadingImagesSlider(
                     ...
                     iconSize: 20,autoFade: false,
                      ...
                      images: [Image.asset('assets/images/o/jumping.gif'),
                        Image.asset(
