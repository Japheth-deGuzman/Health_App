...
class HamstringJacks extends StatefulWidget {
  HamstringJacks({Key? key}) : super(key: key);
  @override
  _HamstringJacksState createState() => _HamstringJacksState();
}

class _HamstringJacksState extends State<HamstringJacks> {
  ...
  String time = '';
  String secs = '';
  String exercise = 'Hamstring Jacks';
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: FadingImagesSlider(
                      ...
                      images: [
                        Image.asset('assets/images/o/hamstring.gif'),
                        Image.asset('assets/images/low/hamstring_jacks.gif')
                      ],
                    ),
                  ),
                  Divider(),
