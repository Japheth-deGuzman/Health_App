...
class SquatToJab extends StatefulWidget {
  const SquatToJab({Key? key}) : super(key: key);

  @override
  _SquatToJabState createState() => _SquatToJabState();
}

class _SquatToJabState extends State<SquatToJab> {
  bool isCliked = true;
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: FadingImagesSlider(
                      ...
                      images: [
                        Image.asset('assets/images/o/jab.gif'),
                        Image.asset('assets/images/low/squat_to_jab.gif'),
                      ],
                    ),
                  ),
                  Divider(),
