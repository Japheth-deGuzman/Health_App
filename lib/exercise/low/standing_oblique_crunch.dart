...
class StandingObliqueCrunch extends StatefulWidget {
  const StandingObliqueCrunch({Key? key}) : super(key: key);

  @override
  _StandingObliqueCrunchState createState() => _StandingObliqueCrunchState();
}

class _StandingObliqueCrunchState extends State<StandingObliqueCrunch> {
  bool isCliked = true;
  ...
  String time = '';
  String secs = '';
  String exercise = 'Stunding Oblique Crunch';
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: FadingImagesSlider(
                      ...
                      images: [
                        Image.asset('assets/images/o/crunch.gif'),
                        Image.asset(
