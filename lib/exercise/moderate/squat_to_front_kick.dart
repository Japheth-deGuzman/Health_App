...
class SquatToFrontKick extends StatefulWidget {
  const SquatToFrontKick({Key? key}) : super(key: key);

  @override
  _SquatToFrontKickState createState() => _SquatToFrontKickState();
}

class _SquatToFrontKickState extends State<SquatToFrontKick> {
  bool isCliked = true;
  ...
  String time = '';
  String secs = '';
  String exercise = 'Squat Tto Front Kick';
                  ...
                  Container(
                    ...
                    child: FadingImagesSlider(
                     ...
                     iconSize: 20,autoFade: false,
                      ...
                      images: [  Image.asset('assets/images/o/front kick.gif'),
                        Image.asset('assets/images/moderate/squat_to_front_kick.gif')
