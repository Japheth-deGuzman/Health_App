...
class StandingAlternatingToeTouches extends StatefulWidget {
  const StandingAlternatingToeTouches({Key? key}) : super(key: key);
  @override
  _StandingAlternatingToeTouchesState createState() =>
      _StandingAlternatingToeTouchesState();
}

class _StandingAlternatingToeTouchesState
    extends State<StandingAlternatingToeTouches> {
  bool isCliked = true;
  ...
  String time = '';
  String secs = '';
  String exercise = 'Standing Alternating Toe Touches';
  String level = 'Moderate Level Exercise';
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: FadingImagesSlider(
                      ...
                      images: [
                        Image.asset('assets/images/o/toe.gif'),
                        Image.asset(
