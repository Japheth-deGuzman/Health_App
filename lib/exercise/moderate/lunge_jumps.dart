...
class LungeJumps extends StatefulWidget {
  const LungeJumps({Key? key}) : super(key: key);

  @override
  _LungeJumpsState createState() => _LungeJumpsState();
}

class _LungeJumpsState extends State<LungeJumps> {
  bool isCliked = true;
                  ...
                  Container(
                    ...
                    child: FadingImagesSlider(
                     ...
                     iconSize: 20,autoFade: false,
                      ...
                      images: [Image.asset('assets/images/o/lunges.gif'),
                        Image.asset('assets/images/moderate/lunge_jumps.gif')
