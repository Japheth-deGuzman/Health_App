...
class SquatJumps extends StatefulWidget {
  const SquatJumps({Key? key}) : super(key: key);

  @override
  _SquatJumpsState createState() => _SquatJumpsState();
}

class _SquatJumpsState extends State<SquatJumps> {
  bool isCliked = true;
                  ...
                  Container(
                    ...
                    child: FadingImagesSlider(
                     ...
                     iconSize: 20,autoFade: false,
                      ...
                      images: [ Image.asset('assets/images/o/squat.gif'),
                        Image.asset('assets/images/moderate/squat_jumps.gif')
