...
class LateralShuffles extends StatefulWidget {
  const LateralShuffles({Key? key}) : super(key: key);

  @override
  _LateralShufflesState createState() => _LateralShufflesState();
}

class _LateralShufflesState extends State<LateralShuffles> {
  bool isCliked = true;
  ...
  String secs = '';
  String time = '';
  String exercise = 'Lateral Shuffles';
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: FadingImagesSlider(
                      ...
                      images: [
                        Image.asset('assets/images/o/lateral.gif'),
                        Image.asset(
