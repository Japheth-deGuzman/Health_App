...
class DiagonalJumps extends StatefulWidget {
  const DiagonalJumps({Key? key}) : super(key: key);

  @override
  _DiagonalJumpsState createState() => _DiagonalJumpsState();
}

class _DiagonalJumpsState extends State<DiagonalJumps> {
  bool isCliked = true;
  ...
  String time = '';
  String secs = '';
  String exercise = 'Diagonal Jumps';
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: FadingImagesSlider(
                      ...
                      images: [
                        Image.asset('assets/images/o/diagonal.gif'),
                        Image.asset('assets/images/vigorous/diagonal_jumps.gif')
                      ],
                    ),
                  ),
                  Divider(),
