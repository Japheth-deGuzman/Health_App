...
class InchwormCrawl extends StatefulWidget {
  const InchwormCrawl({Key? key}) : super(key: key);

  @override
  _InchwormCrawlsState createState() => _InchwormCrawlsState();
}

class _InchwormCrawlsState extends State<InchwormCrawl> {
  bool isCliked = true;
  ...
  String time = '';
  String secs = '';
  String exercise = 'Inchworm Crawl';
                  ...
                  Container(
                    ...
                    child: FadingImagesSlider(
                     ...
                     iconSize: 20,autoFade: false,
                      ...
                      images: [Image.asset('assets/images/o/inchworm.gif'),
                        Image.asset('assets/images/vigorous/inchworm_crawl.gif')
