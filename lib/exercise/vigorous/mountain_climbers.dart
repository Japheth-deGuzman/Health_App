...
class MountainClimbers extends StatefulWidget {
  const MountainClimbers({Key? key}) : super(key: key);

  @override
  _MountainClimbersState createState() => _MountainClimbersState();
}
...
class _MountainClimbersState extends State<MountainClimbers> {
  ...
  String time = '';
  String secs = '';
  String exercise = 'Mountain Climbers';
                  ...
                  Container(
                    ...
                    child: FadingImagesSlider(
                     ...
                     iconSize: 20,autoFade: false,
                      ...
                      images: [Image.asset('assets/images/o/climbers.gif'),
                        Image.asset('assets/images/vigorous/mountain_climbers.gif')
